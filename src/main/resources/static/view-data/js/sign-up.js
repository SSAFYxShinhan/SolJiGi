...
function oneAuthCheck() {
    let oneAuthKey = document.getElementById("one-auth-check-key").value;
    if (oneAuthKey === "SSAFY 1234") {
        document.getElementById("sign-up-btn").className
